...
export const Chat: React.FC<ChatProps> = ({ roomId, username, userId }) => {
  const { joinRoom, messages, activeUsers, typingUsers, isConnected } =
    useSocket()
    ...
    <div className="relative">
      ...
      <form onSubmit={handleSubmit} className="flex items-center space-x-2">
        ...
        <button
          ...
          className="rounded-full bg-blue-500 px-6 py-2 text-white hover:bg-blue-600 focus:ring-2 focus:ring-blue-500 focus:outline-none disabled:opacity-50"
        >
          Send
        </button>
      </form>
